...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden py-10">
      ...
      <div className="max-w-md w-full space-y-8 bg-white/80 backdrop-blur-xl p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/20 relative z-10 animate-fade-in-up">
        <div className="relative">
          ...
          <p className="mt-3 text-center text-sm text-gray-600">
            Join us to get personalized course recommendations
          </p>
        </div>
